...
import com.hung.gameobject.BackgroundMap;
import com.hung.gameobject.BulletManager;
import com.hung.gameobject.Camera;
import com.hung.gameobject.DarkRaise;
import com.hung.gameobject.FinalBoss;
import com.hung.gameobject.MegaMan;
import com.hung.gameobject.ParticularObject;
import com.hung.gameobject.ParticularObjectManager;
import com.hung.gameobject.PhysicalMap;
import com.hung.gameobject.RedEyeDevil;
import com.hung.gameobject.RobotR;
import com.hung.gameobject.SmallRedGun;
...
public class GameWorldState extends State {
    ...
    public GameWorldState(GamePanel gamePanel){
        ...
        texts1[0] = "Chúng ta là những anh hùng và nhiệm vụ của chúng ta là bảo vệ Ngôi nhà của chúng ta\n"
        +"và trái đất của chúng ta....";
        texts1[1] = "có một con quái vật đã tồn tại trên trái đất 10 năm nay\n"
                + "và chúng ta đã sống trong nỗi sợ hãi trong 10 năm đó.³....";
        texts1[2] = "Bây giờ là lúc cho chúng ta, giết nó và có được tự do!!....";
        texts1[3] = "Bạn đã sẵn sàng chiến đấu cùng với chúng tôi.....\nOK LET GO";
        ...
        if(g2!=null){
            ...
            switch(state){
                case INIT_GAME:
                    ...
                    g2.setColor(Color.WHITE);
                    g2.drawString("Bấm ENTER để tiếp tục", 400, 300);
                    break;
                case PAUSEGAME:
                    g2.setColor(Color.BLACK);
